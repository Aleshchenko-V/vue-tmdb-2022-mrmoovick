<template>
  <div class="tags">
    <div :class="isActive ? 'tag highlight' : `tag` " v-for="tag in genres" :key="tag.id"
         @click="myToggle($event, tag.id), getFilter({
...
export default {
  ...
  computed: {
    ...mapState(['selectedGenres', "leftRatingRangeValue", "rightRatingRangeValue", "leftYearRangeValue", "rightYearRangeValue", "selectedValue"])
  }
}
</script>
